...
/* Generated from ../O.Common/wasseruhr.dbd */
...
int wasseruhr_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/epics/Wasseruhr";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"wasseruhr_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    wasseruhr_registerRecordDeviceDriver(*iocshPpdbbase);
}
